...
public class addlead extends Basetest {
    ...
    @Test
    public void TC_AddLead_SDT_Validate_09() throws Throwable{
        loginPg = new LoginPage(driver);
        addleadPg =new addleadPage(driver);
        loginPg.login1(User, Pass);
        Thread.sleep(1000);
    ...
    @Test
    public void TC_AddLead_SDT_Validate_10() throws Throwable{
        loginPg = new LoginPage(driver);
        addleadPg =new addleadPage(driver);
        loginPg.login1(User, Pass);
        Thread.sleep(1000);
    ...
    @Test
    public void TC_AddLead_SDT_Validate_11() throws Throwable{
        loginPg = new LoginPage(driver);
        addleadPg =new addleadPage(driver);
        loginPg.login1(User, Pass);
        Thread.sleep(1000);
    ...
    @Test
    public void TC_AddLead_SDT_Validate_12() throws Throwable{
        loginPg = new LoginPage(driver);
        addleadPg =new addleadPage(driver);
        loginPg.login1(User, Pass);
        Thread.sleep(1000);
    ...
    @Test
    public void TC_AddLead_SDT_Validate_13() throws Throwable{
        loginPg = new LoginPage(driver);
        Thread.sleep(1000);
        addleadPg =new addleadPage(driver);
        loginPg.login1(User, Pass);
    ...
    @Test
    public void TC_AddLead_SDT_Validate_14() throws Throwable{
        loginPg = new LoginPage(driver);
        Thread.sleep(1000);
        addleadPg =new addleadPage(driver);
        loginPg.login1(User, Pass);
    ...
    @Test
    public void TC_AddLead_SDT_Validate_15() throws Throwable{
        loginPg = new LoginPage(driver);
        Thread.sleep(1000);
        addleadPg =new addleadPage(driver);
        loginPg.login1(User, Pass);
